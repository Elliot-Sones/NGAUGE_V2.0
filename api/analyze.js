...
const ANALYSIS_CONFIGS = {
  ...
  'team-insights': {
    ...
    maxOutputTokens: 8192,  // Increased to prevent MAX_TOKENS cutoff (gemini-2.5-flash supports up to 8192)
  }
};
...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (geminiData.candidates?.[0]?.finishReason === 'MAX_TOKENS') {
      console.warn('⚠️ Response was truncated due to MAX_TOKENS. Consider increasing maxOutputTokens.');
    }
