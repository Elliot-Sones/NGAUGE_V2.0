...
const Dashboard = () => {
  ...
  // Disabled auto-generation to prevent overlay showing before authentication
  // Users can manually click "Explain Scores" and "Generate Insights" buttons
  // const hasAutoGenerated = React.useRef(false);

  // React.useEffect(() => {
  //   // Auto-generation disabled - see above comment
  // }, [loading, data.length]);
